...
<div class="potalWrap">
	...
	<jsp:include page="../common/inc_header.jsp">
		...
		<jsp:param name="titleTxt" value="콜 통계(시도기준)"/>
	</jsp:include>
	<!-- .#header -->
...
jQuery.event.add(window,"load",function(){
	$(document).ready(function (){
        ...
        //jqGrid
        $("#jqGrid").jqGrid({
        	url: "${pageContext.request.contextPath}/getObStatsAttemptJQList",
        	//data: mydata,
            datatype: "local",
            height: 'auto',
            rowNum: 30,
            ...
            colNames:['구분','사용DB수','연결성공','통화중','결번','수신거부','계','목적성공','재통화예약','부재중','통화중끊김','통화거부','계','연결율','시도율','연결율','성공율','총통화시간','평균통화시간','총통화시간','평균통화시간'],
            colModel:[
				...
				{name:'rule01', index:'rule01', width:60, align:'center'},
                {name:'rule02', index:'rule02', width:60, align:'center'},
                {name:'rule03', index:'rule03', width:60, align:'center'},
