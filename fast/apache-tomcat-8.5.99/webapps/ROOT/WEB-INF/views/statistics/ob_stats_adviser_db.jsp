...
<div id="wrap">
	...
	<jsp:include page="../common/inc_header.jsp">
		...
		<jsp:param name="titleTxt" value="상담원별 통계(DB기준)"/>
	</jsp:include>
	 <!-- .#header -->
        ...
        <div class="srchArea">
            <table class="tbl_line_view" summary="검색유형/모음기준/제외여부/검색일자/개인지정으로 구성됨">
                ...
                <tr>
                    ...
                    <td>
                        <div class="radioBox">                                            
                            <input type="radio" name="ipt_radio1" id="ipt_radio1_1" class="ipt_radio">
                            <label for="ipt_radio1_1">30분 단위</label>
                            <input type="radio" name="ipt_radio1" id="ipt_radio1_2" class="ipt_radio">
                            <label for="ipt_radio1_2">시간 단위</label>
                            <input type="radio" name="ipt_radio1" id="ipt_radio1_3" class="ipt_radio" checked>
                            <label for="ipt_radio1_3">일 단위</label>
                            <input type="radio" name="ipt_radio1" id="ipt_radio1_4" class="ipt_radio">
                            <label for="ipt_radio1_4">요일 단위</label>
                            <input type="radio" name="ipt_radio1" id="ipt_radio1_5" class="ipt_radio">
                    ...
                    <td>
                        <div class="radioBox">                                            
                            <input type="radio" name="ipt_radio2" id="ipt_radio2_1" class="ipt_radio" >
                            <label for="ipt_radio2_1">개인 | (시/일/월/요일)</label>
                            <input type="radio" name="ipt_radio2" id="ipt_radio2_2" class="ipt_radio" checked>
	...
	$(document).ready(function (){
        ...
        $("#export").on("click", function(){
			$("#jqGrid").jqGrid("exportToExcel",{
    		  ...
    		  includeFooter: true,
    		  fileName : "O/B 상담원별 Call 통계-DB.xlsx",
        ...
        $("#jqGrid").jqGrid({
            url: "${pageContext.request.contextPath}/getObStatsAdviserDBJQList",
        	//data: mydata,
            datatype: "local",
            height: 'auto',
            rowNum: 30,
